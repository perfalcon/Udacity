...
import static com.example.android.sunshine.data.SunshinePreferences.getEllapsedTimeSinceLastNotification;
...
//              TODO (14) Check if a day has passed since the last notification
                ...
                Log.v ("SunSync-->","--->"+timeSinceLastNotification);
                if (timeSinceLastNotification >= DateUtils.SECOND_IN_MILLIS) {
